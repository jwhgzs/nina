...
// imports from: https://www.cnblogs.com/anjing/archive/2009/12/25/1632016.html
public class NinaImportsILReader {
    private OpCode[] multiByteOpCodes = new OpCode[0];

    private OpCode[] singleByteOpCodes = new OpCode[0];
